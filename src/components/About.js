    ...
    return (
      ...
      <div id="aboutContainer" className="info">
        ...
        <div id="about2" className="text">
          ...
          <p>Hi there! <br/><br/>
          I am a full stack web developer with a passion for creating positive user experiences. I have practice in HTML5, CSS, Ruby, Ruby on Rails, JavaScript (ES6), AngularJS, React and Redux. I enjoy problem solving and have an aptitude for learning new languages quickly and efficiently.
          <br/><br/>
          &lt; 3<br/>
